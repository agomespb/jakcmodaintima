 ...
 */
class Role extends \AGAcl\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AGAcl\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'AGAcl\\Entity\\Role' . "\0" . 'nome', '' . "\0" . 'AGAcl\\Entity\\Role' . "\0" . 'isAdmin', '' . "\0" . 'AGAcl\\Entity\\Role' . "\0" . 'createdAt', '' . "\0" . 'AGAcl\\Entity\\Role' . "\0" . 'updatedAt', '' . "\0" . 'AGAcl\\Entity\\Role' . "\0" . 'parent');
        }
