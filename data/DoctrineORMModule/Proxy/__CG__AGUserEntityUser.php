...
namespace DoctrineORMModule\Proxy\__CG__\AGUser\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \AGUser\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AGUser\\Entity\\User' . "\0" . 'id', '' . "\0" . 'AGUser\\Entity\\User' . "\0" . 'role', '' . "\0" . 'AGUser\\Entity\\User' . "\0" . 'nome', '' . "\0" . 'AGUser\\Entity\\User' . "\0" . 'email', '' . "\0" . 'AGUser\\Entity\\User' . "\0" . 'password', '' . "\0" . 'AGUser\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'AGUser\\Entity\\User' . "\0" . 'active', '' . "\0" . 'AGUser\\Entity\\User' . "\0" . 'activationKey', '' . "\0" . 'AGUser\\Entity\\User' . "\0" . 'updatedAt', '' . "\0" . 'AGUser\\Entity\\User' . "\0" . 'createdAt');
        }
