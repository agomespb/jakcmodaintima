...
namespace DoctrineORMModule\Proxy\__CG__\AGAcl\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Privilege extends \AGAcl\Entity\Privilege implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AGAcl\\Entity\\Privilege' . "\0" . 'id', '' . "\0" . 'AGAcl\\Entity\\Privilege' . "\0" . 'nome', '' . "\0" . 'AGAcl\\Entity\\Privilege' . "\0" . 'createdAt', '' . "\0" . 'AGAcl\\Entity\\Privilege' . "\0" . 'updatedAt', '' . "\0" . 'AGAcl\\Entity\\Privilege' . "\0" . 'resource', '' . "\0" . 'AGAcl\\Entity\\Privilege' . "\0" . 'role');
        }
